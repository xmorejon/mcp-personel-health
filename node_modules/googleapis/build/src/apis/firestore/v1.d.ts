...
export declare namespace firestore_v1 {
    ...
    export interface Schema$GoogleFirestoreAdminV1IndexField {
         ...
         */
        searchConfig?: Schema$GoogleFirestoreAdminV1SearchConfig;
        /**
     ...
     */
    export interface Schema$GoogleFirestoreAdminV1SearchConfig {
        /**
         * Optional. The specification for building a geo search index for a field.
         */
        geoSpec?: Schema$GoogleFirestoreAdminV1SearchGeoSpec;
        /**
         * Optional. The specification for building a text search index for a field.
         */
        textSpec?: Schema$GoogleFirestoreAdminV1SearchTextSpec;
    }
    /**
     ...
     */
    export interface Schema$GoogleFirestoreAdminV1SearchIndexOptions {
        /**
     ...
     */
    export interface Schema$GoogleFirestoreAdminV1SearchTextIndexSpec {
        /**
     ...
     */
    export interface Schema$GoogleFirestoreAdminV1SearchTextSpec {
        /**
         * Required. Specifications for how the field should be indexed. Repeated so that the field can be indexed in multiple ways.
         */
        indexSpecs?: Schema$GoogleFirestoreAdminV1SearchTextIndexSpec[];
    }
    /**
    ...
    export class Resource$Projects$Databases$Documents {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        executePipeline(params: Params$Resource$Projects$Databases$Documents$Executepipeline, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        executePipeline(params?: Params$Resource$Projects$Databases$Documents$Executepipeline, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ExecutePipelineResponse>>;
        executePipeline(params: Params$Resource$Projects$Databases$Documents$Executepipeline, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        executePipeline(params: Params$Resource$Projects$Databases$Documents$Executepipeline, options: MethodOptions | BodyResponseCallback<Schema$ExecutePipelineResponse>, callback: BodyResponseCallback<Schema$ExecutePipelineResponse>): void;
        executePipeline(params: Params$Resource$Projects$Databases$Documents$Executepipeline, callback: BodyResponseCallback<Schema$ExecutePipelineResponse>): void;
        executePipeline(callback: BodyResponseCallback<Schema$ExecutePipelineResponse>): void;
        /**
