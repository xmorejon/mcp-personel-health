...
export declare namespace workspaceevents_v1 {
    ...
    export class Resource$Message {
         ...
         */
        stream(params: Params$Resource$Message$Stream, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        stream(params?: Params$Resource$Message$Stream, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$StreamResponse>>;
        stream(params: Params$Resource$Message$Stream, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        stream(params: Params$Resource$Message$Stream, options: MethodOptions | BodyResponseCallback<Schema$StreamResponse>, callback: BodyResponseCallback<Schema$StreamResponse>): void;
        stream(params: Params$Resource$Message$Stream, callback: BodyResponseCallback<Schema$StreamResponse>): void;
    ...
    export class Resource$Tasks {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        cancel(params: Params$Resource$Tasks$Cancel, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        cancel(params?: Params$Resource$Tasks$Cancel, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Task>>;
        cancel(params: Params$Resource$Tasks$Cancel, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        cancel(params: Params$Resource$Tasks$Cancel, options: MethodOptions | BodyResponseCallback<Schema$Task>, callback: BodyResponseCallback<Schema$Task>): void;
        cancel(params: Params$Resource$Tasks$Cancel, callback: BodyResponseCallback<Schema$Task>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        subscribe(params: Params$Resource$Tasks$Subscribe, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        subscribe(params?: Params$Resource$Tasks$Subscribe, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$StreamResponse>>;
        subscribe(params: Params$Resource$Tasks$Subscribe, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        subscribe(params: Params$Resource$Tasks$Subscribe, options: MethodOptions | BodyResponseCallback<Schema$StreamResponse>, callback: BodyResponseCallback<Schema$StreamResponse>): void;
        subscribe(params: Params$Resource$Tasks$Subscribe, callback: BodyResponseCallback<Schema$StreamResponse>): void;
    ...
    export class Resource$Tasks$Pushnotificationconfigs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Tasks$Pushnotificationconfigs$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Tasks$Pushnotificationconfigs$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TaskPushNotificationConfig>>;
        create(params: Params$Resource$Tasks$Pushnotificationconfigs$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Tasks$Pushnotificationconfigs$Create, options: MethodOptions | BodyResponseCallback<Schema$TaskPushNotificationConfig>, callback: BodyResponseCallback<Schema$TaskPushNotificationConfig>): void;
        create(params: Params$Resource$Tasks$Pushnotificationconfigs$Create, callback: BodyResponseCallback<Schema$TaskPushNotificationConfig>): void;
        create(callback: BodyResponseCallback<Schema$TaskPushNotificationConfig>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Tasks$Pushnotificationconfigs$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Tasks$Pushnotificationconfigs$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Tasks$Pushnotificationconfigs$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Tasks$Pushnotificationconfigs$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Tasks$Pushnotificationconfigs$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Tasks$Pushnotificationconfigs$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Tasks$Pushnotificationconfigs$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TaskPushNotificationConfig>>;
        get(params: Params$Resource$Tasks$Pushnotificationconfigs$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Tasks$Pushnotificationconfigs$Get, options: MethodOptions | BodyResponseCallback<Schema$TaskPushNotificationConfig>, callback: BodyResponseCallback<Schema$TaskPushNotificationConfig>): void;
        get(params: Params$Resource$Tasks$Pushnotificationconfigs$Get, callback: BodyResponseCallback<Schema$TaskPushNotificationConfig>): void;
        get(callback: BodyResponseCallback<Schema$TaskPushNotificationConfig>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Tasks$Pushnotificationconfigs$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Tasks$Pushnotificationconfigs$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListTaskPushNotificationConfigResponse>>;
        list(params: Params$Resource$Tasks$Pushnotificationconfigs$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Tasks$Pushnotificationconfigs$List, options: MethodOptions | BodyResponseCallback<Schema$ListTaskPushNotificationConfigResponse>, callback: BodyResponseCallback<Schema$ListTaskPushNotificationConfigResponse>): void;
        list(params: Params$Resource$Tasks$Pushnotificationconfigs$List, callback: BodyResponseCallback<Schema$ListTaskPushNotificationConfigResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListTaskPushNotificationConfigResponse>): void;
    }
