...
export declare namespace bigtableadmin_v2 {
    ...
    export class Resource$Projects$Instances$Clusters {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getMemoryLayer(params: Params$Resource$Projects$Instances$Clusters$Getmemorylayer, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getMemoryLayer(params?: Params$Resource$Projects$Instances$Clusters$Getmemorylayer, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$MemoryLayer>>;
        getMemoryLayer(params: Params$Resource$Projects$Instances$Clusters$Getmemorylayer, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getMemoryLayer(params: Params$Resource$Projects$Instances$Clusters$Getmemorylayer, options: MethodOptions | BodyResponseCallback<Schema$MemoryLayer>, callback: BodyResponseCallback<Schema$MemoryLayer>): void;
        getMemoryLayer(params: Params$Resource$Projects$Instances$Clusters$Getmemorylayer, callback: BodyResponseCallback<Schema$MemoryLayer>): void;
    ...
    export class Resource$Projects$Instances$Clusters$Memorylayers {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Instances$Clusters$Memorylayers$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Instances$Clusters$Memorylayers$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListMemoryLayersResponse>>;
        list(params: Params$Resource$Projects$Instances$Clusters$Memorylayers$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Instances$Clusters$Memorylayers$List, options: MethodOptions | BodyResponseCallback<Schema$ListMemoryLayersResponse>, callback: BodyResponseCallback<Schema$ListMemoryLayersResponse>): void;
        list(params: Params$Resource$Projects$Instances$Clusters$Memorylayers$List, callback: BodyResponseCallback<Schema$ListMemoryLayersResponse>): void;
