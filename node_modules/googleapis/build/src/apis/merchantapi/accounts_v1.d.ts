...
export declare namespace merchantapi_accounts_v1 {
    ...
    export class Resource$Accounts {
         ...
         *
         *   // Do the magic
         *   const res = await merchantapi.accounts.createTestAccount({
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        createTestAccount(params: Params$Resource$Accounts$Createtestaccount, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        createTestAccount(params?: Params$Resource$Accounts$Createtestaccount, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Account>>;
        createTestAccount(params: Params$Resource$Accounts$Createtestaccount, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        createTestAccount(params: Params$Resource$Accounts$Createtestaccount, options: MethodOptions | BodyResponseCallback<Schema$Account>, callback: BodyResponseCallback<Schema$Account>): void;
        createTestAccount(params: Params$Resource$Accounts$Createtestaccount, callback: BodyResponseCallback<Schema$Account>): void;
        createTestAccount(callback: BodyResponseCallback<Schema$Account>): void;
        /**
    ...
    export interface Params$Resource$Accounts$Createtestaccount extends StandardParameters {
        /**
         * Required. The account resource name to create the test account under. Format: accounts/{account\}
         */
        parent?: string;
    ...
    export class Resource$Accounts$Users$Me {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        verifySelf(params: Params$Resource$Accounts$Users$Me$Verifyself, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        verifySelf(params?: Params$Resource$Accounts$Users$Me$Verifyself, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$User>>;
        verifySelf(params: Params$Resource$Accounts$Users$Me$Verifyself, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        verifySelf(params: Params$Resource$Accounts$Users$Me$Verifyself, options: MethodOptions | BodyResponseCallback<Schema$User>, callback: BodyResponseCallback<Schema$User>): void;
        verifySelf(params: Params$Resource$Accounts$Users$Me$Verifyself, callback: BodyResponseCallback<Schema$User>): void;
