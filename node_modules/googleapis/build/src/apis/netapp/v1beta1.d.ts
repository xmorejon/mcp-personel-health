...
export declare namespace netapp_v1beta1 {
    ...
    export class Resource$Projects$Locations$Storagepools$Ontap {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        executeOntapDelete(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontapdelete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        executeOntapDelete(params?: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontapdelete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ExecuteOntapDeleteResponse>>;
        executeOntapDelete(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontapdelete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        executeOntapDelete(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontapdelete, options: MethodOptions | BodyResponseCallback<Schema$ExecuteOntapDeleteResponse>, callback: BodyResponseCallback<Schema$ExecuteOntapDeleteResponse>): void;
        executeOntapDelete(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontapdelete, callback: BodyResponseCallback<Schema$ExecuteOntapDeleteResponse>): void;
        executeOntapDelete(callback: BodyResponseCallback<Schema$ExecuteOntapDeleteResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        executeOntapGet(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontapget, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        executeOntapGet(params?: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontapget, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ExecuteOntapGetResponse>>;
        executeOntapGet(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontapget, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        executeOntapGet(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontapget, options: MethodOptions | BodyResponseCallback<Schema$ExecuteOntapGetResponse>, callback: BodyResponseCallback<Schema$ExecuteOntapGetResponse>): void;
        executeOntapGet(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontapget, callback: BodyResponseCallback<Schema$ExecuteOntapGetResponse>): void;
        executeOntapGet(callback: BodyResponseCallback<Schema$ExecuteOntapGetResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        executeOntapPatch(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontappatch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        executeOntapPatch(params?: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontappatch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ExecuteOntapPatchResponse>>;
        executeOntapPatch(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontappatch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        executeOntapPatch(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontappatch, options: MethodOptions | BodyResponseCallback<Schema$ExecuteOntapPatchResponse>, callback: BodyResponseCallback<Schema$ExecuteOntapPatchResponse>): void;
        executeOntapPatch(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontappatch, callback: BodyResponseCallback<Schema$ExecuteOntapPatchResponse>): void;
        executeOntapPatch(callback: BodyResponseCallback<Schema$ExecuteOntapPatchResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        executeOntapPost(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontappost, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        executeOntapPost(params?: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontappost, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ExecuteOntapPostResponse>>;
        executeOntapPost(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontappost, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        executeOntapPost(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontappost, options: MethodOptions | BodyResponseCallback<Schema$ExecuteOntapPostResponse>, callback: BodyResponseCallback<Schema$ExecuteOntapPostResponse>): void;
        executeOntapPost(params: Params$Resource$Projects$Locations$Storagepools$Ontap$Executeontappost, callback: BodyResponseCallback<Schema$ExecuteOntapPostResponse>): void;
        executeOntapPost(callback: BodyResponseCallback<Schema$ExecuteOntapPostResponse>): void;
    }
