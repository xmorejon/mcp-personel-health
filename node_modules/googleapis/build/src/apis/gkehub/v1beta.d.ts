...
export declare namespace gkehub_v1beta {
    ...
    export class Resource$Projects$Locations$Rollouts {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        forceCompleteStage(params: Params$Resource$Projects$Locations$Rollouts$Forcecompletestage, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        forceCompleteStage(params?: Params$Resource$Projects$Locations$Rollouts$Forcecompletestage, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        forceCompleteStage(params: Params$Resource$Projects$Locations$Rollouts$Forcecompletestage, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        forceCompleteStage(params: Params$Resource$Projects$Locations$Rollouts$Forcecompletestage, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        forceCompleteStage(params: Params$Resource$Projects$Locations$Rollouts$Forcecompletestage, callback: BodyResponseCallback<Schema$Operation>): void;
