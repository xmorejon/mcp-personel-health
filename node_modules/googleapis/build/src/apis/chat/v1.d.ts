...
export declare namespace chat_v1 {
     ...
     */
    export interface Schema$FindGroupChatsResponse {
        /**
     ...
     */
    export interface Schema$GoogleChatV1Section {
        /**
     ...
     */
    export interface Schema$ListSectionItemsResponse {
        /**
         ...
         */
        sectionItems?: Schema$SectionItem[];
    }
    /**
     * Response message for listing sections.
     */
    export interface Schema$ListSectionsResponse {
        /**
         * A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages.
         */
        nextPageToken?: string | null;
         ...
         */
        sections?: Schema$GoogleChatV1Section[];
    }
    /**
     ...
     */
    export interface Schema$MoveSectionItemRequest {
        /**
     ...
     */
    export interface Schema$MoveSectionItemResponse {
        /**
         * The updated section item.
         */
        sectionItem?: Schema$SectionItem;
    }
    /**
     ...
     */
    export interface Schema$PositionSectionRequest {
        /**
     ...
     */
    export interface Schema$PositionSectionResponse {
        /**
         * The updated section.
         */
     ...
     */
    export interface Schema$SectionItem {
        /**
    ...
    export class Resource$Spaces {
         ...
         *
         *   // Do the magic
         *   const res = await chat.spaces.findGroupChats({
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        findGroupChats(params: Params$Resource$Spaces$Findgroupchats, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        findGroupChats(params?: Params$Resource$Spaces$Findgroupchats, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FindGroupChatsResponse>>;
        findGroupChats(params: Params$Resource$Spaces$Findgroupchats, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        findGroupChats(params: Params$Resource$Spaces$Findgroupchats, options: MethodOptions | BodyResponseCallback<Schema$FindGroupChatsResponse>, callback: BodyResponseCallback<Schema$FindGroupChatsResponse>): void;
        findGroupChats(params: Params$Resource$Spaces$Findgroupchats, callback: BodyResponseCallback<Schema$FindGroupChatsResponse>): void;
        findGroupChats(callback: BodyResponseCallback<Schema$FindGroupChatsResponse>): void;
        /**
    ...
    export interface Params$Resource$Spaces$Findgroupchats extends StandardParameters {
        /**
         * Optional. The maximum number of spaces to return. The service might return fewer than this value. If unspecified, at most 10 spaces are returned. The maximum value is 30. If you use a value more than 30, it's automatically changed to 30. Negative values return an `INVALID_ARGUMENT` error.
         */
        pageSize?: number;
    ...
    export class Resource$Users$Sections {
        context: APIRequestContext;
        items: Resource$Users$Sections$Items;
        constructor(context: APIRequestContext);
        /**
         ...
         *
         *   // Do the magic
         *   const res = await chat.users.sections.create({
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Users$Sections$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Users$Sections$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChatV1Section>>;
        create(params: Params$Resource$Users$Sections$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Users$Sections$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleChatV1Section>, callback: BodyResponseCallback<Schema$GoogleChatV1Section>): void;
        create(params: Params$Resource$Users$Sections$Create, callback: BodyResponseCallback<Schema$GoogleChatV1Section>): void;
        create(callback: BodyResponseCallback<Schema$GoogleChatV1Section>): void;
        /**
         ...
         *
         *   // Do the magic
         *   const res = await chat.users.sections.delete({
         *     // Required. The name of the section to delete. Format: `users/{user\}/sections/{section\}`
         *     name: 'users/my-user/sections/my-section',
         *   });
         *   console.log(res.data);
         *
         *   // Example response
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Users$Sections$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Users$Sections$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Users$Sections$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Users$Sections$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Users$Sections$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         *
         *   // Do the magic
         *   const res = await chat.users.sections.list({
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Users$Sections$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Users$Sections$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListSectionsResponse>>;
        list(params: Params$Resource$Users$Sections$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Users$Sections$List, options: MethodOptions | BodyResponseCallback<Schema$ListSectionsResponse>, callback: BodyResponseCallback<Schema$ListSectionsResponse>): void;
        list(params: Params$Resource$Users$Sections$List, callback: BodyResponseCallback<Schema$ListSectionsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListSectionsResponse>): void;
        /**
         ...
         *
         *   // Do the magic
         *   const res = await chat.users.sections.patch({
         *     // Identifier. Resource name of the section. For system sections, the section ID is a constant string: - DEFAULT_DIRECT_MESSAGES: `users/{user\}/sections/default-direct-messages` - DEFAULT_SPACES: `users/{user\}/sections/default-spaces` - DEFAULT_APPS: `users/{user\}/sections/default-apps` Format: `users/{user\}/sections/{section\}`
         *     name: 'users/my-user/sections/my-section',
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Users$Sections$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Users$Sections$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChatV1Section>>;
        patch(params: Params$Resource$Users$Sections$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Users$Sections$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleChatV1Section>, callback: BodyResponseCallback<Schema$GoogleChatV1Section>): void;
        patch(params: Params$Resource$Users$Sections$Patch, callback: BodyResponseCallback<Schema$GoogleChatV1Section>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleChatV1Section>): void;
        /**
         ...
         *
         *   // Do the magic
         *   const res = await chat.users.sections.position({
         ...
         *       // request body parameters
         *       // {
         *       //   "relativePosition": "my_relativePosition",
         *       //   "sortOrder": 0
         *       // }
         *     },
         *   });
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        position(params: Params$Resource$Users$Sections$Position, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        position(params?: Params$Resource$Users$Sections$Position, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$PositionSectionResponse>>;
        position(params: Params$Resource$Users$Sections$Position, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        position(params: Params$Resource$Users$Sections$Position, options: MethodOptions | BodyResponseCallback<Schema$PositionSectionResponse>, callback: BodyResponseCallback<Schema$PositionSectionResponse>): void;
        position(params: Params$Resource$Users$Sections$Position, callback: BodyResponseCallback<Schema$PositionSectionResponse>): void;
        position(callback: BodyResponseCallback<Schema$PositionSectionResponse>): void;
    }
    export interface Params$Resource$Users$Sections$Create extends StandardParameters {
        /**
         * Required. The parent resource name where the section is created. Format: `users/{user\}`
         */
        parent?: string;
    ...
    export interface Params$Resource$Users$Sections$Delete extends StandardParameters {
        /**
         * Required. The name of the section to delete. Format: `users/{user\}/sections/{section\}`
         */
        name?: string;
    }
    export interface Params$Resource$Users$Sections$List extends StandardParameters {
        /**
         * Optional. The maximum number of sections to return. The service may return fewer than this value. If unspecified, at most 10 sections will be returned. The maximum value is 100. If you use a value more than 100, it's automatically changed to 100. Negative values return an `INVALID_ARGUMENT` error.
         */
        pageSize?: number;
    ...
    export interface Params$Resource$Users$Sections$Patch extends StandardParameters {
        /**
         * Identifier. Resource name of the section. For system sections, the section ID is a constant string: - DEFAULT_DIRECT_MESSAGES: `users/{user\}/sections/default-direct-messages` - DEFAULT_SPACES: `users/{user\}/sections/default-spaces` - DEFAULT_APPS: `users/{user\}/sections/default-apps` Format: `users/{user\}/sections/{section\}`
         */
        name?: string;
    ...
    export interface Params$Resource$Users$Sections$Position extends StandardParameters {
        /**
         * Required. The resource name of the section to position. Format: `users/{user\}/sections/{section\}`
         */
        name?: string;
         ...
         * Request body metadata
         */
        requestBody?: Schema$PositionSectionRequest;
    }
    export class Resource$Users$Sections$Items {
        context: APIRequestContext;
        constructor(context: APIRequestContext);
        /**
         ...
         *
         *   // Do the magic
         *   const res = await chat.users.sections.items.list({
         ...
         *     parent: 'users/my-user/sections/my-section',
         *   });
         *   console.log(res.data);
         *
         *   // Example response
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Users$Sections$Items$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Users$Sections$Items$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListSectionItemsResponse>>;
        list(params: Params$Resource$Users$Sections$Items$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Users$Sections$Items$List, options: MethodOptions | BodyResponseCallback<Schema$ListSectionItemsResponse>, callback: BodyResponseCallback<Schema$ListSectionItemsResponse>): void;
        list(params: Params$Resource$Users$Sections$Items$List, callback: BodyResponseCallback<Schema$ListSectionItemsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListSectionItemsResponse>): void;
        /**
         ...
         *
         *   // Do the magic
         *   const res = await chat.users.sections.items.move({
         *     // Required. The resource name of the section item to move. Format: `users/{user\}/sections/{section\}/items/{item\}`
         *     name: 'users/my-user/sections/my-section/items/my-item',
         *
         *     // Request body metadata
         *     requestBody: {
         *       // request body parameters
         *       // {
         *       //   "targetSection": "my_targetSection"
         *       // }
         *     },
         *   });
         *   console.log(res.data);
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        move(params: Params$Resource$Users$Sections$Items$Move, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        move(params?: Params$Resource$Users$Sections$Items$Move, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$MoveSectionItemResponse>>;
        move(params: Params$Resource$Users$Sections$Items$Move, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        move(params: Params$Resource$Users$Sections$Items$Move, options: MethodOptions | BodyResponseCallback<Schema$MoveSectionItemResponse>, callback: BodyResponseCallback<Schema$MoveSectionItemResponse>): void;
        move(params: Params$Resource$Users$Sections$Items$Move, callback: BodyResponseCallback<Schema$MoveSectionItemResponse>): void;
        move(callback: BodyResponseCallback<Schema$MoveSectionItemResponse>): void;
    }
    export interface Params$Resource$Users$Sections$Items$List extends StandardParameters {
        /**
         * Optional. A query filter. Currently only supports filtering by space. For example, `space = spaces/{space\}`. Invalid queries are rejected with an `INVALID_ARGUMENT` error.
         */
        filter?: string;
    ...
    export interface Params$Resource$Users$Sections$Items$Move extends StandardParameters {
        /**
         * Required. The resource name of the section item to move. Format: `users/{user\}/sections/{section\}/items/{item\}`
         */
        name?: string;
         ...
         * Request body metadata
         */
        requestBody?: Schema$MoveSectionItemRequest;
    }
