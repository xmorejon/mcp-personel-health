...
export declare namespace memcache_v1 {
    ...
    export class Resource$Projects$Locations$Instances {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getTags(params: Params$Resource$Projects$Locations$Instances$Gettags, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getTags(params?: Params$Resource$Projects$Locations$Instances$Gettags, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GetTagsResponse>>;
        getTags(params: Params$Resource$Projects$Locations$Instances$Gettags, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getTags(params: Params$Resource$Projects$Locations$Instances$Gettags, options: MethodOptions | BodyResponseCallback<Schema$GetTagsResponse>, callback: BodyResponseCallback<Schema$GetTagsResponse>): void;
        getTags(params: Params$Resource$Projects$Locations$Instances$Gettags, callback: BodyResponseCallback<Schema$GetTagsResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        setTags(params: Params$Resource$Projects$Locations$Instances$Settags, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        setTags(params?: Params$Resource$Projects$Locations$Instances$Settags, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SetTagsResponse>>;
        setTags(params: Params$Resource$Projects$Locations$Instances$Settags, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        setTags(params: Params$Resource$Projects$Locations$Instances$Settags, options: MethodOptions | BodyResponseCallback<Schema$SetTagsResponse>, callback: BodyResponseCallback<Schema$SetTagsResponse>): void;
        setTags(params: Params$Resource$Projects$Locations$Instances$Settags, callback: BodyResponseCallback<Schema$SetTagsResponse>): void;
