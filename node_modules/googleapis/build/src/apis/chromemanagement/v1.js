...
(function (chromemanagement_v1) {
    ...
    class Resource$Customers {
        ...
        constructor(context) {
            ...
            this.connectorConfigs = new Resource$Customers$Connectorconfigs(this.context);
    ...
    class Resource$Customers$Connectorconfigs {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/connectorConfigs').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    chromemanagement_v1.Resource$Customers$Connectorconfigs = Resource$Customers$Connectorconfigs;
    ...
    class Resource$Customers$Reports {
        ...
        findInstalledAppProfiles(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+customer}/reports:findInstalledAppProfiles').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
