...
export declare namespace chromemanagement_v1 {
    ...
    export class Resource$Customers$Connectorconfigs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Customers$Connectorconfigs$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Customers$Connectorconfigs$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>>;
        create(params: Params$Resource$Customers$Connectorconfigs$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Customers$Connectorconfigs$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>): void;
        create(params: Params$Resource$Customers$Connectorconfigs$Create, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>): void;
        create(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Customers$Connectorconfigs$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Customers$Connectorconfigs$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleProtobufEmpty>>;
        delete(params: Params$Resource$Customers$Connectorconfigs$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Customers$Connectorconfigs$Delete, options: MethodOptions | BodyResponseCallback<Schema$GoogleProtobufEmpty>, callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        delete(params: Params$Resource$Customers$Connectorconfigs$Delete, callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Customers$Connectorconfigs$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Customers$Connectorconfigs$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>>;
        get(params: Params$Resource$Customers$Connectorconfigs$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Customers$Connectorconfigs$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>): void;
        get(params: Params$Resource$Customers$Connectorconfigs$Get, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>): void;
        get(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Customers$Connectorconfigs$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Customers$Connectorconfigs$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1ListConnectorConfigsResponse>>;
        list(params: Params$Resource$Customers$Connectorconfigs$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Customers$Connectorconfigs$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListConnectorConfigsResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListConnectorConfigsResponse>): void;
        list(params: Params$Resource$Customers$Connectorconfigs$List, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListConnectorConfigsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListConnectorConfigsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Customers$Connectorconfigs$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Customers$Connectorconfigs$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>>;
        patch(params: Params$Resource$Customers$Connectorconfigs$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Customers$Connectorconfigs$Patch, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>): void;
        patch(params: Params$Resource$Customers$Connectorconfigs$Patch, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>): void;
        patch(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ConnectorConfig>): void;
    }
    ...
    export class Resource$Customers$Reports {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        findInstalledAppProfiles(params: Params$Resource$Customers$Reports$Findinstalledappprofiles, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        findInstalledAppProfiles(params?: Params$Resource$Customers$Reports$Findinstalledappprofiles, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1FindInstalledAppProfilesResponse>>;
        findInstalledAppProfiles(params: Params$Resource$Customers$Reports$Findinstalledappprofiles, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        findInstalledAppProfiles(params: Params$Resource$Customers$Reports$Findinstalledappprofiles, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementV1FindInstalledAppProfilesResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1FindInstalledAppProfilesResponse>): void;
        findInstalledAppProfiles(params: Params$Resource$Customers$Reports$Findinstalledappprofiles, callback: BodyResponseCallback<Schema$GoogleChromeManagementV1FindInstalledAppProfilesResponse>): void;
        findInstalledAppProfiles(callback: BodyResponseCallback<Schema$GoogleChromeManagementV1FindInstalledAppProfilesResponse>): void;
    }
