...
export declare namespace firebaseapphosting_v1beta {
    ...
    export class Resource$Projects$Locations$Supportedruntimes {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Supportedruntimes$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Supportedruntimes$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListSupportedRuntimesResponse>>;
        list(params: Params$Resource$Projects$Locations$Supportedruntimes$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Supportedruntimes$List, options: MethodOptions | BodyResponseCallback<Schema$ListSupportedRuntimesResponse>, callback: BodyResponseCallback<Schema$ListSupportedRuntimesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Supportedruntimes$List, callback: BodyResponseCallback<Schema$ListSupportedRuntimesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListSupportedRuntimesResponse>): void;
    }
