...
export declare namespace admin_directory_v1 {
    ...
    export class Resource$Customer$Devices$Chromeos {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countChromeOsDevices(params: Params$Resource$Customer$Devices$Chromeos$Countchromeosdevices, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countChromeOsDevices(params?: Params$Resource$Customer$Devices$Chromeos$Countchromeosdevices, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$CountChromeOsDevicesResponse>>;
        countChromeOsDevices(params: Params$Resource$Customer$Devices$Chromeos$Countchromeosdevices, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        countChromeOsDevices(params: Params$Resource$Customer$Devices$Chromeos$Countchromeosdevices, options: MethodOptions | BodyResponseCallback<Schema$CountChromeOsDevicesResponse>, callback: BodyResponseCallback<Schema$CountChromeOsDevicesResponse>): void;
        countChromeOsDevices(params: Params$Resource$Customer$Devices$Chromeos$Countchromeosdevices, callback: BodyResponseCallback<Schema$CountChromeOsDevicesResponse>): void;
        countChromeOsDevices(callback: BodyResponseCallback<Schema$CountChromeOsDevicesResponse>): void;
        /**
    ...
    export class Resource$Users {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        createGuest(params: Params$Resource$Users$Createguest, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        createGuest(params?: Params$Resource$Users$Createguest, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$User>>;
        createGuest(params: Params$Resource$Users$Createguest, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        createGuest(params: Params$Resource$Users$Createguest, options: MethodOptions | BodyResponseCallback<Schema$User>, callback: BodyResponseCallback<Schema$User>): void;
        createGuest(params: Params$Resource$Users$Createguest, callback: BodyResponseCallback<Schema$User>): void;
