...
export declare namespace backupdr_v1 {
    ...
    export class Resource$Folders$Locations$Resourcebackupconfigs {
         ...
         */
        fetch(params: Params$Resource$Folders$Locations$Resourcebackupconfigs$Fetch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetch(params?: Params$Resource$Folders$Locations$Resourcebackupconfigs$Fetch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchResourceBackupConfigsResponse>>;
        fetch(params: Params$Resource$Folders$Locations$Resourcebackupconfigs$Fetch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetch(params: Params$Resource$Folders$Locations$Resourcebackupconfigs$Fetch, options: MethodOptions | BodyResponseCallback<Schema$FetchResourceBackupConfigsResponse>, callback: BodyResponseCallback<Schema$FetchResourceBackupConfigsResponse>): void;
        fetch(params: Params$Resource$Folders$Locations$Resourcebackupconfigs$Fetch, callback: BodyResponseCallback<Schema$FetchResourceBackupConfigsResponse>): void;
        fetch(callback: BodyResponseCallback<Schema$FetchResourceBackupConfigsResponse>): void;
    }
    ...
    export class Resource$Organizations$Locations$Resourcebackupconfigs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetch(params: Params$Resource$Organizations$Locations$Resourcebackupconfigs$Fetch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetch(params?: Params$Resource$Organizations$Locations$Resourcebackupconfigs$Fetch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchResourceBackupConfigsResponse>>;
        fetch(params: Params$Resource$Organizations$Locations$Resourcebackupconfigs$Fetch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetch(params: Params$Resource$Organizations$Locations$Resourcebackupconfigs$Fetch, options: MethodOptions | BodyResponseCallback<Schema$FetchResourceBackupConfigsResponse>, callback: BodyResponseCallback<Schema$FetchResourceBackupConfigsResponse>): void;
        fetch(params: Params$Resource$Organizations$Locations$Resourcebackupconfigs$Fetch, callback: BodyResponseCallback<Schema$FetchResourceBackupConfigsResponse>): void;
        fetch(callback: BodyResponseCallback<Schema$FetchResourceBackupConfigsResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Resourcebackupconfigs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetch(params: Params$Resource$Projects$Locations$Resourcebackupconfigs$Fetch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetch(params?: Params$Resource$Projects$Locations$Resourcebackupconfigs$Fetch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchResourceBackupConfigsResponse>>;
        fetch(params: Params$Resource$Projects$Locations$Resourcebackupconfigs$Fetch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetch(params: Params$Resource$Projects$Locations$Resourcebackupconfigs$Fetch, options: MethodOptions | BodyResponseCallback<Schema$FetchResourceBackupConfigsResponse>, callback: BodyResponseCallback<Schema$FetchResourceBackupConfigsResponse>): void;
        fetch(params: Params$Resource$Projects$Locations$Resourcebackupconfigs$Fetch, callback: BodyResponseCallback<Schema$FetchResourceBackupConfigsResponse>): void;
        fetch(callback: BodyResponseCallback<Schema$FetchResourceBackupConfigsResponse>): void;
        /**
