...
export declare namespace workstations_v1beta {
    ...
    export class Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        pushCredentials(params: Params$Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations$Pushcredentials, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        pushCredentials(params?: Params$Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations$Pushcredentials, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        pushCredentials(params: Params$Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations$Pushcredentials, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        pushCredentials(params: Params$Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations$Pushcredentials, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        pushCredentials(params: Params$Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations$Pushcredentials, callback: BodyResponseCallback<Schema$Operation>): void;
