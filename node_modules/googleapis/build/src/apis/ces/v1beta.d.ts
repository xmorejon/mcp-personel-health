...
export declare namespace ces_v1beta {
    ...
    export class Resource$Projects$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getSecuritySettings(params: Params$Resource$Projects$Locations$Getsecuritysettings, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getSecuritySettings(params?: Params$Resource$Projects$Locations$Getsecuritysettings, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SecuritySettings>>;
        getSecuritySettings(params: Params$Resource$Projects$Locations$Getsecuritysettings, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getSecuritySettings(params: Params$Resource$Projects$Locations$Getsecuritysettings, options: MethodOptions | BodyResponseCallback<Schema$SecuritySettings>, callback: BodyResponseCallback<Schema$SecuritySettings>): void;
        getSecuritySettings(params: Params$Resource$Projects$Locations$Getsecuritysettings, callback: BodyResponseCallback<Schema$SecuritySettings>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateSecuritySettings(params: Params$Resource$Projects$Locations$Updatesecuritysettings, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        updateSecuritySettings(params?: Params$Resource$Projects$Locations$Updatesecuritysettings, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SecuritySettings>>;
        updateSecuritySettings(params: Params$Resource$Projects$Locations$Updatesecuritysettings, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        updateSecuritySettings(params: Params$Resource$Projects$Locations$Updatesecuritysettings, options: MethodOptions | BodyResponseCallback<Schema$SecuritySettings>, callback: BodyResponseCallback<Schema$SecuritySettings>): void;
        updateSecuritySettings(params: Params$Resource$Projects$Locations$Updatesecuritysettings, callback: BodyResponseCallback<Schema$SecuritySettings>): void;
        updateSecuritySettings(callback: BodyResponseCallback<Schema$SecuritySettings>): void;
    }
    ...
    export class Resource$Projects$Locations$Apps {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generateAppResource(params: Params$Resource$Projects$Locations$Apps$Generateappresource, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        generateAppResource(params?: Params$Resource$Projects$Locations$Apps$Generateappresource, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        generateAppResource(params: Params$Resource$Projects$Locations$Apps$Generateappresource, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        generateAppResource(params: Params$Resource$Projects$Locations$Apps$Generateappresource, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        generateAppResource(params: Params$Resource$Projects$Locations$Apps$Generateappresource, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        importEvaluations(params: Params$Resource$Projects$Locations$Apps$Importevaluations, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        importEvaluations(params?: Params$Resource$Projects$Locations$Apps$Importevaluations, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        importEvaluations(params: Params$Resource$Projects$Locations$Apps$Importevaluations, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        importEvaluations(params: Params$Resource$Projects$Locations$Apps$Importevaluations, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        importEvaluations(params: Params$Resource$Projects$Locations$Apps$Importevaluations, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        runEvaluation(params: Params$Resource$Projects$Locations$Apps$Runevaluation, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        runEvaluation(params?: Params$Resource$Projects$Locations$Apps$Runevaluation, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        runEvaluation(params: Params$Resource$Projects$Locations$Apps$Runevaluation, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        runEvaluation(params: Params$Resource$Projects$Locations$Apps$Runevaluation, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        runEvaluation(params: Params$Resource$Projects$Locations$Apps$Runevaluation, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        testPersonaVoice(params: Params$Resource$Projects$Locations$Apps$Testpersonavoice, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        testPersonaVoice(params?: Params$Resource$Projects$Locations$Apps$Testpersonavoice, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TestPersonaVoiceResponse>>;
        testPersonaVoice(params: Params$Resource$Projects$Locations$Apps$Testpersonavoice, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        testPersonaVoice(params: Params$Resource$Projects$Locations$Apps$Testpersonavoice, options: MethodOptions | BodyResponseCallback<Schema$TestPersonaVoiceResponse>, callback: BodyResponseCallback<Schema$TestPersonaVoiceResponse>): void;
        testPersonaVoice(params: Params$Resource$Projects$Locations$Apps$Testpersonavoice, callback: BodyResponseCallback<Schema$TestPersonaVoiceResponse>): void;
        testPersonaVoice(callback: BodyResponseCallback<Schema$TestPersonaVoiceResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Apps$Conversations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generateEvaluation(params: Params$Resource$Projects$Locations$Apps$Conversations$Generateevaluation, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        generateEvaluation(params?: Params$Resource$Projects$Locations$Apps$Conversations$Generateevaluation, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        generateEvaluation(params: Params$Resource$Projects$Locations$Apps$Conversations$Generateevaluation, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        generateEvaluation(params: Params$Resource$Projects$Locations$Apps$Conversations$Generateevaluation, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        generateEvaluation(params: Params$Resource$Projects$Locations$Apps$Conversations$Generateevaluation, callback: BodyResponseCallback<Schema$Operation>): void;
    ...
    export class Resource$Projects$Locations$Apps$Evaluationdatasets {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$EvaluationDataset>>;
        create(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Create, options: MethodOptions | BodyResponseCallback<Schema$EvaluationDataset>, callback: BodyResponseCallback<Schema$EvaluationDataset>): void;
        create(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Create, callback: BodyResponseCallback<Schema$EvaluationDataset>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$EvaluationDataset>>;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Get, options: MethodOptions | BodyResponseCallback<Schema$EvaluationDataset>, callback: BodyResponseCallback<Schema$EvaluationDataset>): void;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Get, callback: BodyResponseCallback<Schema$EvaluationDataset>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListEvaluationDatasetsResponse>>;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$List, options: MethodOptions | BodyResponseCallback<Schema$ListEvaluationDatasetsResponse>, callback: BodyResponseCallback<Schema$ListEvaluationDatasetsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$List, callback: BodyResponseCallback<Schema$ListEvaluationDatasetsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListEvaluationDatasetsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$EvaluationDataset>>;
        patch(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Patch, options: MethodOptions | BodyResponseCallback<Schema$EvaluationDataset>, callback: BodyResponseCallback<Schema$EvaluationDataset>): void;
        patch(params: Params$Resource$Projects$Locations$Apps$Evaluationdatasets$Patch, callback: BodyResponseCallback<Schema$EvaluationDataset>): void;
    ...
    export class Resource$Projects$Locations$Apps$Evaluationexpectations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$EvaluationExpectation>>;
        create(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Create, options: MethodOptions | BodyResponseCallback<Schema$EvaluationExpectation>, callback: BodyResponseCallback<Schema$EvaluationExpectation>): void;
        create(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Create, callback: BodyResponseCallback<Schema$EvaluationExpectation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$EvaluationExpectation>>;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Get, options: MethodOptions | BodyResponseCallback<Schema$EvaluationExpectation>, callback: BodyResponseCallback<Schema$EvaluationExpectation>): void;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Get, callback: BodyResponseCallback<Schema$EvaluationExpectation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListEvaluationExpectationsResponse>>;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$List, options: MethodOptions | BodyResponseCallback<Schema$ListEvaluationExpectationsResponse>, callback: BodyResponseCallback<Schema$ListEvaluationExpectationsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$List, callback: BodyResponseCallback<Schema$ListEvaluationExpectationsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListEvaluationExpectationsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$EvaluationExpectation>>;
        patch(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Patch, options: MethodOptions | BodyResponseCallback<Schema$EvaluationExpectation>, callback: BodyResponseCallback<Schema$EvaluationExpectation>): void;
        patch(params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Patch, callback: BodyResponseCallback<Schema$EvaluationExpectation>): void;
    ...
    export class Resource$Projects$Locations$Apps$Evaluationruns {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Apps$Evaluationruns$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        export(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$Export, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        export(params?: Params$Resource$Projects$Locations$Apps$Evaluationruns$Export, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        export(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$Export, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        export(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$Export, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        export(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$Export, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Apps$Evaluationruns$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$EvaluationRun>>;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$Get, options: MethodOptions | BodyResponseCallback<Schema$EvaluationRun>, callback: BodyResponseCallback<Schema$EvaluationRun>): void;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$Get, callback: BodyResponseCallback<Schema$EvaluationRun>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Apps$Evaluationruns$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListEvaluationRunsResponse>>;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$List, options: MethodOptions | BodyResponseCallback<Schema$ListEvaluationRunsResponse>, callback: BodyResponseCallback<Schema$ListEvaluationRunsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluationruns$List, callback: BodyResponseCallback<Schema$ListEvaluationRunsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListEvaluationRunsResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Apps$Evaluations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Apps$Evaluations$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Apps$Evaluations$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Evaluation>>;
        create(params: Params$Resource$Projects$Locations$Apps$Evaluations$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Apps$Evaluations$Create, options: MethodOptions | BodyResponseCallback<Schema$Evaluation>, callback: BodyResponseCallback<Schema$Evaluation>): void;
        create(params: Params$Resource$Projects$Locations$Apps$Evaluations$Create, callback: BodyResponseCallback<Schema$Evaluation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluations$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Apps$Evaluations$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluations$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluations$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluations$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         * Exports evaluations.
         * @example
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        export(params: Params$Resource$Projects$Locations$Apps$Evaluations$Export, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        export(params?: Params$Resource$Projects$Locations$Apps$Evaluations$Export, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        export(params: Params$Resource$Projects$Locations$Apps$Evaluations$Export, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        export(params: Params$Resource$Projects$Locations$Apps$Evaluations$Export, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        export(params: Params$Resource$Projects$Locations$Apps$Evaluations$Export, callback: BodyResponseCallback<Schema$Operation>): void;
        export(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Apps$Evaluations$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Apps$Evaluations$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Evaluation>>;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluations$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluations$Get, options: MethodOptions | BodyResponseCallback<Schema$Evaluation>, callback: BodyResponseCallback<Schema$Evaluation>): void;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluations$Get, callback: BodyResponseCallback<Schema$Evaluation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Apps$Evaluations$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Apps$Evaluations$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListEvaluationsResponse>>;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluations$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluations$List, options: MethodOptions | BodyResponseCallback<Schema$ListEvaluationsResponse>, callback: BodyResponseCallback<Schema$ListEvaluationsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluations$List, callback: BodyResponseCallback<Schema$ListEvaluationsResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Apps$Evaluations$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Apps$Evaluations$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Evaluation>>;
        patch(params: Params$Resource$Projects$Locations$Apps$Evaluations$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Apps$Evaluations$Patch, options: MethodOptions | BodyResponseCallback<Schema$Evaluation>, callback: BodyResponseCallback<Schema$Evaluation>): void;
        patch(params: Params$Resource$Projects$Locations$Apps$Evaluations$Patch, callback: BodyResponseCallback<Schema$Evaluation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        uploadEvaluationAudio(params: Params$Resource$Projects$Locations$Apps$Evaluations$Uploadevaluationaudio, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        uploadEvaluationAudio(params?: Params$Resource$Projects$Locations$Apps$Evaluations$Uploadevaluationaudio, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UploadEvaluationAudioResponse>>;
        uploadEvaluationAudio(params: Params$Resource$Projects$Locations$Apps$Evaluations$Uploadevaluationaudio, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        uploadEvaluationAudio(params: Params$Resource$Projects$Locations$Apps$Evaluations$Uploadevaluationaudio, options: MethodOptions | BodyResponseCallback<Schema$UploadEvaluationAudioResponse>, callback: BodyResponseCallback<Schema$UploadEvaluationAudioResponse>): void;
        uploadEvaluationAudio(params: Params$Resource$Projects$Locations$Apps$Evaluations$Uploadevaluationaudio, callback: BodyResponseCallback<Schema$UploadEvaluationAudioResponse>): void;
        uploadEvaluationAudio(callback: BodyResponseCallback<Schema$UploadEvaluationAudioResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Apps$Evaluations$Results {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        export(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Export, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        export(params?: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Export, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        export(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Export, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        export(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Export, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        export(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Export, callback: BodyResponseCallback<Schema$Operation>): void;
        export(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$EvaluationResult>>;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Get, options: MethodOptions | BodyResponseCallback<Schema$EvaluationResult>, callback: BodyResponseCallback<Schema$EvaluationResult>): void;
        get(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Get, callback: BodyResponseCallback<Schema$EvaluationResult>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Apps$Evaluations$Results$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListEvaluationResultsResponse>>;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$List, options: MethodOptions | BodyResponseCallback<Schema$ListEvaluationResultsResponse>, callback: BodyResponseCallback<Schema$ListEvaluationResultsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$List, callback: BodyResponseCallback<Schema$ListEvaluationResultsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListEvaluationResultsResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Apps$Scheduledevaluationruns {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ScheduledEvaluationRun>>;
        create(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Create, options: MethodOptions | BodyResponseCallback<Schema$ScheduledEvaluationRun>, callback: BodyResponseCallback<Schema$ScheduledEvaluationRun>): void;
        create(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Create, callback: BodyResponseCallback<Schema$ScheduledEvaluationRun>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(callback: BodyResponseCallback<Schema$Empty>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ScheduledEvaluationRun>>;
        get(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Get, options: MethodOptions | BodyResponseCallback<Schema$ScheduledEvaluationRun>, callback: BodyResponseCallback<Schema$ScheduledEvaluationRun>): void;
        get(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Get, callback: BodyResponseCallback<Schema$ScheduledEvaluationRun>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListScheduledEvaluationRunsResponse>>;
        list(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$List, options: MethodOptions | BodyResponseCallback<Schema$ListScheduledEvaluationRunsResponse>, callback: BodyResponseCallback<Schema$ListScheduledEvaluationRunsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$List, callback: BodyResponseCallback<Schema$ListScheduledEvaluationRunsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListScheduledEvaluationRunsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ScheduledEvaluationRun>>;
        patch(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Patch, options: MethodOptions | BodyResponseCallback<Schema$ScheduledEvaluationRun>, callback: BodyResponseCallback<Schema$ScheduledEvaluationRun>): void;
        patch(params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Patch, callback: BodyResponseCallback<Schema$ScheduledEvaluationRun>): void;
