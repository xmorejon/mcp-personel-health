...
export declare namespace androidpublisher_v3 {
    ...
    export class Resource$Applications$Tracks$Releases {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Applications$Tracks$Releases$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Applications$Tracks$Releases$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListReleaseSummariesResponse>>;
        list(params: Params$Resource$Applications$Tracks$Releases$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Applications$Tracks$Releases$List, options: MethodOptions | BodyResponseCallback<Schema$ListReleaseSummariesResponse>, callback: BodyResponseCallback<Schema$ListReleaseSummariesResponse>): void;
        list(params: Params$Resource$Applications$Tracks$Releases$List, callback: BodyResponseCallback<Schema$ListReleaseSummariesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListReleaseSummariesResponse>): void;
    }
    ...
    export class Resource$Purchases$Subscriptionsv2 {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        defer(params: Params$Resource$Purchases$Subscriptionsv2$Defer, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        defer(params?: Params$Resource$Purchases$Subscriptionsv2$Defer, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$DeferSubscriptionPurchaseResponse>>;
        defer(params: Params$Resource$Purchases$Subscriptionsv2$Defer, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        defer(params: Params$Resource$Purchases$Subscriptionsv2$Defer, options: MethodOptions | BodyResponseCallback<Schema$DeferSubscriptionPurchaseResponse>, callback: BodyResponseCallback<Schema$DeferSubscriptionPurchaseResponse>): void;
        defer(params: Params$Resource$Purchases$Subscriptionsv2$Defer, callback: BodyResponseCallback<Schema$DeferSubscriptionPurchaseResponse>): void;
        defer(callback: BodyResponseCallback<Schema$DeferSubscriptionPurchaseResponse>): void;
        /**
